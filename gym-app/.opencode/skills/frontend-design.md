...
- **Constraints**: Technical requirements (framework, performance, accessibility). *Ensure the text remains legible and high-contrast regardless of the chosen theme.*
...
Focus on:
- **Typography**: Choose fonts that are beautiful, unique, and interesting. Avoid generic fonts like Arial and Inter; opt instead for distinctive choices. *CRITICAL: Always include the necessary font imports (e.g., Google Fonts) in the code so they render correctly.*
...
**IMPORTANT**: Match implementation complexity to the aesthetic vision. Maximalist designs need elaborate code with extensive animations and effects. Minimalist or refined designs need restraint, precision, and careful attention to spacing, typography, and subtle details. Always deliver fully self-contained, working code files (including any required external styles/CDNs).